...
},{"./../fonts/AvenirLT-Book.ttf":[["AvenirLT-Book.75c68e39.ttf","fonts/AvenirLT-Book.ttf"],"fonts/AvenirLT-Book.ttf"],"./../fonts/BarlowCondensed-Medium.ttf":[["BarlowCondensed-Medium.b08c1485.ttf","fonts/BarlowCondensed-Medium.ttf"],"fonts/BarlowCondensed-Medium.ttf"],"./../fonts/BarlowCondensed-SemiBold.ttf":[["BarlowCondensed-SemiBold.dbebe294.ttf","fonts/BarlowCondensed-SemiBold.ttf"],"fonts/BarlowCondensed-SemiBold.ttf"],"./../img/decor-radial.svg":[["decor-radial.e6c12ad2.svg","img/decor-radial.svg"],"img/decor-radial.svg"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"node_modules/process/browser.js"}],"node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
},{"./Observer.js":"node_modules/gsap/Observer.js"}],"js/lib/greensock.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = initGreenSock;
...
function setupFadeInElement(elem) {
  ...
  var anim = _gsap.default.to(elem, {
    duration: 1,
    autoAlpha: 1,
    y: 0,
    delay: 0.3,
...
},{}],"js/lib/headroom.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = initHeadroom;
var _headroom = _interopRequireDefault(require("headroom.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function initHeadroom() {
  var theHeader = document.querySelector('.js-header');
  var headroom = new _headroom.default(theHeader, {
    offset: 0,
    tolerance: 5
  });
  headroom.init();
}
},{"headroom.js":"node_modules/headroom.js/dist/headroom.js"}],"js/lib/mobile-nav.js":[function(require,module,exports) {
"use strict";
...
var $header = (0, _jquery.default)('.js-header');
var $mobileNav = (0, _jquery.default)('.js-mobile-nav');
var $hamburger = (0, _jquery.default)('.js-hamburger');
...
exports.default = initA11yFunctions;
var _jquery = _interopRequireDefault(require("jquery"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var $doc = (0, _jquery.default)(document);
function menuDropdownA11y() {
  ...
  */
  ...
  var menuContainer = (0, _jquery.default)('.js-header');
  var siteHeaderMenu = menuContainer.find('.js-header-wrapper');
  ...
  var dropdownToggle = (0, _jquery.default)('<button />', {
  ...
  (0, _jquery.default)('.menu-item-has-children > a').after(dropdownToggle);
  ...
  siteHeaderMenu.find('.dropdown-toggle').click(function (e) {
    var screenReaderSpan = (0, _jquery.default)(this).find('.u-sr-only');
    e.preventDefault();
    (0, _jquery.default)(this).toggleClass('toggled-on');
    (0, _jquery.default)(this).nextAll('.sub-menu').toggleClass('toggled-on');

    // jscs:disable
    (0, _jquery.default)(this).attr('aria-expanded', (0, _jquery.default)(this).attr('aria-expanded') === 'false' ? 'true' : 'false');
    // jscs:enable
    screenReaderSpan.text(screenReaderSpan.text() === screenReaderText.expand ? screenReaderText.collapse : screenReaderText.expand);
  });

  // Adds a class to sub-menus for styling
  (0, _jquery.default)('.sub-menu .menu-item-has-children').parent('.sub-menu').addClass('has-sub-menu');

  // Keyboard navigation
  (0, _jquery.default)('.menu-item a, button.dropdown-toggle').on('keydown', function (e) {
    ...
    switch (e.keyCode) {
      case 37:
        ...
        e.preventDefault();
        e.stopPropagation();
        if ((0, _jquery.default)(this).hasClass('dropdown-toggle')) {
          (0, _jquery.default)(this).prev('a').focus();
        } else {
          if ((0, _jquery.default)(this).parent().prev().children('button.dropdown-toggle').length) {
            (0, _jquery.default)(this).parent().prev().children('button.dropdown-toggle').focus();
          } else {
            (0, _jquery.default)(this).parent().prev().children('a').focus();
          }
        }
        if ((0, _jquery.default)(this).is('ul ul ul.sub-menu.toggled-on li:first-child a')) {
          (0, _jquery.default)(this).parents('ul.sub-menu.toggled-on li').children('button.dropdown-toggle').focus();
        }
        break;
      case 39:
        // right key
        e.preventDefault();
        e.stopPropagation();
        if ((0, _jquery.default)(this).next('button.dropdown-toggle').length) {
          (0, _jquery.default)(this).next('button.dropdown-toggle').focus();
        } else {
          (0, _jquery.default)(this).parent().next().children('a').focus();
        }
        if ((0, _jquery.default)(this).is('ul.sub-menu .dropdown-toggle.toggled-on')) {
          (0, _jquery.default)(this).parent().find('ul.sub-menu li:first-child a').focus();
        }
        break;
      case 40:
        // down key
        e.preventDefault();
        e.stopPropagation();
        if ((0, _jquery.default)(this).next().length) {
          (0, _jquery.default)(this).next().find('li:first-child a').first().focus();
        } else {
          (0, _jquery.default)(this).parent().next().children('a').focus();
        }
        if ((0, _jquery.default)(this).is('ul.sub-menu a') && (0, _jquery.default)(this).next('button.dropdown-toggle').length) {
          (0, _jquery.default)(this).parent().next().children('a').focus();
        }
        if ((0, _jquery.default)(this).is('ul.sub-menu .dropdown-toggle') && (0, _jquery.default)(this).parent().next().children('.dropdown-toggle').length) {
          (0, _jquery.default)(this).parent().next().children('.dropdown-toggle').focus();
        }
        break;
      case 38:
        // up key
        e.preventDefault();
        e.stopPropagation();
        if ((0, _jquery.default)(this).parent().prev().length) {
          (0, _jquery.default)(this).parent().prev().children('a').focus();
        } else {
          (0, _jquery.default)(this).parents('ul').first().prev('.dropdown-toggle.toggled-on').focus();
        }
        if ((0, _jquery.default)(this).is('ul.sub-menu .dropdown-toggle') && (0, _jquery.default)(this).parent().prev().children('.dropdown-toggle').length) {
          (0, _jquery.default)(this).parent().prev().children('.dropdown-toggle').focus();
        }
        break;
    }
  });
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"node_modules/magnific-popup/dist/jquery.magnific-popup.js":[function(require,module,exports) {
var define;
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"js/lib/video-popup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = initVideoPlay;
var _jquery = _interopRequireDefault(require("jquery"));
var _magnificPopup = _interopRequireDefault(require("magnific-popup"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var $doc = (0, _jquery.default)(document);
function playVideo(event) {
  var videoSrc = (0, _jquery.default)(event.currentTarget).data('url');
  event.preventDefault();
  ...
  _jquery.default.magnificPopup.open({
    ...
    iframe: {
      markup: '<div class="mfp-video-header">' + '<div class="mfp-close"></div>' + '</div>' + '<div class="mfp-iframe-scaler">' + '<iframe class="mfp-iframe" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen ></iframe>' + '</div>',
...
var _headroom = _interopRequireDefault(require("./lib/headroom"));
...
require("./js/index.js");
},{"./sass/index.scss":"sass/index.scss","./js/index.js":"js/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3500" + '/');
...
//# sourceMappingURL=/global.f0063984.js.map